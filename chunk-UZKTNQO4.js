...
`)}var $m={[Ho]:"Linear",[Wo]:"Reinhard",[Xo]:"Cineon",[qo]:"ACESFilmic",[Zo]:"AgX",[$o]:"Neutral",[Yo]:"Custom"};function Jm(i,e){let t=$m[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Na=new O;function Km(){ke.getLuminanceCoefficients(Na);let i=Na.x.toFixed(4),e=Na.y.toFixed(4),t=Na.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var ag={[As]:"SHADOWMAP_TYPE_PCF",[Hi]:"SHADOWMAP_TYPE_VSM"};function og(i){return ag[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var lg={[Xn]:"ENVMAP_TYPE_CUBE",[pi]:"ENVMAP_TYPE_CUBE",[Es]:"ENVMAP_TYPE_CUBE_UV"};function cg(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":lg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var hg={[pi]:"ENVMAP_MODE_REFRACTION"};function ug(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":hg[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var dg={[Go]:"ENVMAP_BLENDING_MULTIPLY",[$c]:"ENVMAP_BLENDING_MIX",[Jc]:"ENVMAP_BLENDING_ADD"};function fg(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":dg[i.combine]||"ENVMAP_BLENDING_NONE"}function pg(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function mg(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=og(t),l=cg(t),u=ug(t),p=fg(t),h=pg(t),g=jm(t),_=Qm(r),y=s.createProgram(),f,d,M=t.glslVersion?"#version "+t.glslVersion+`
...
}`,Rg=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],Ig=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],Lh=new lt,Fs=new O,pl=new O;function Pg(i,e,t){let n=new _s,s=new Ze,r=new Ze,a=new rt,o=new Fr,c=new Lr,l={},u=t.maxTextureSize,p={[Sn]:Tt,[Tt]:Sn,[cn]:cn},h=new Ot({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ze},radius:{value:4}},vertexShader:Tg,fragmentShader:Cg}),g=h.clone();g.defines.HORIZONTAL_PASS=1;let _=new It;_.setAttribute("position",new _t(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new Gt(_,h),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=As;let d=this.type;this.render=function(C,I,x){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||C.length===0)return;this.type===Ic&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=As);let b=i.getRenderTarget(),Y=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),B=i.state;B.setBlending(hn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let z=d!==this.type;z&&I.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(V=>V.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,V=C.length;W<V;W++){let k=C[W],L=k.shadow;if(L===void 0){Re("WebGLShadowMap:",k,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);let Q=L.getFrameExtents();s.multiply(Q),r.copy(L.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Q.x),s.x=r.x*Q.x,L.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Q.y),s.y=r.y*Q.y,L.mapSize.y=r.y));let J=i.state.buffers.depth.getReversed();if(L.camera._reversedDepth=J,L.map===null||z===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Hi){if(k.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new Ut(s.x,s.y,{format:mi,type:un,minFilter:yt,magFilter:yt,generateMipmaps:!1}),L.map.texture.name=k.name+".shadowMap",L.map.depthTexture=new kn(s.x,s.y,Kt),L.map.depthTexture.name=k.name+".shadowMapDepth",L.map.depthTexture.format=on,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=xt,L.map.depthTexture.magFilter=xt}else k.isPointLight?(L.map=new Oa(s.x),L.map.depthTexture=new Pr(s.x,Jt)):(L.map=new Ut(s.x,s.y),L.map.depthTexture=new kn(s.x,s.y,Jt)),L.map.depthTexture.name=k.name+".shadowMap",L.map.depthTexture.format=on,this.type===As?(L.map.depthTexture.compareFunction=J?Fa:Da,L.map.depthTexture.minFilter=yt,L.map.depthTexture.magFilter=yt):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=xt,L.map.depthTexture.magFilter=xt);L.camera.updateProjectionMatrix()}let ce=L.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<ce;pe++){if(L.map.isWebGLCubeRenderTarget)i.setRenderTarget(L.map,pe),i.clear();else{pe===0&&(i.setRenderTarget(L.map),i.clear());let ue=L.getViewport(pe);a.set(r.x*ue.x,r.y*ue.y,r.x*ue.z,r.y*ue.w),B.viewport(a)}if(k.isPointLight){let ue=L.camera,Ne=L.matrix,nt=k.distance||ue.far;nt!==ue.far&&(ue.far=nt,ue.updateProjectionMatrix()),Fs.setFromMatrixPosition(k.matrixWorld),ue.position.copy(Fs),pl.copy(ue.position),pl.add(Rg[pe]),ue.up.copy(Ig[pe]),ue.lookAt(pl),ue.updateMatrixWorld(),Ne.makeTranslation(-Fs.x,-Fs.y,-Fs.z),Lh.multiplyMatrices(ue.projectionMatrix,ue.matrixWorldInverse),L._frustum.setFromProjectionMatrix(Lh,ue.coordinateSystem,ue.reversedDepth)}else L.updateMatrices(k);n=L.getFrustum(),A(I,x,L.camera,k,this.type)}L.isPointLightShadow!==!0&&this.type===Hi&&M(L,x),L.needsUpdate=!1}d=this.type,f.needsUpdate=!1,i.setRenderTarget(b,Y,w)};function M(C,I){let x=e.update(y);h.defines.VSM_SAMPLES!==C.blurSamples&&(h.defines.VSM_SAMPLES=C.blurSamples,g.defines.VSM_SAMPLES=C.blurSamples,h.needsUpdate=!0,g.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Ut(s.x,s.y,{format:mi,type:un})),h.uniforms.shadow_pass.value=C.map.depthTexture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(I,null,x,h,y,null),g.uniforms.shadow_pass.value=C.mapPass.texture,g.uniforms.resolution.value=C.mapSize,g.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(I,null,x,g,y,null)}function E(C,I,x,b){let Y=null,w=x.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(w!==void 0)Y=w;else if(Y=x.isPointLight===!0?c:o,i.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){let B=Y.uuid,z=I.uuid,W=l[B];W===void 0&&(W={},l[B]=W);let V=W[z];V===void 0&&(V=Y.clone(),W[z]=V,I.addEventListener("dispose",R)),Y=V}if(Y.visible=I.visible,Y.wireframe=I.wireframe,b===Hi?Y.side=I.shadowSide!==null?I.shadowSide:I.side:Y.side=I.shadowSide!==null?I.shadowSide:p[I.side],Y.alphaMap=I.alphaMap,Y.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,Y.map=I.map,Y.clipShadows=I.clipShadows,Y.clippingPlanes=I.clippingPlanes,Y.clipIntersection=I.clipIntersection,Y.displacementMap=I.displacementMap,Y.displacementScale=I.displacementScale,Y.displacementBias=I.displacementBias,Y.wireframeLinewidth=I.wireframeLinewidth,Y.linewidth=I.linewidth,x.isPointLight===!0&&Y.isMeshDistanceMaterial===!0){let B=i.properties.get(Y);B.light=x}return Y}function A(C,I,x,b,Y){if(C.visible===!1)return;if(C.layers.test(I.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&Y===Hi)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,C.matrixWorld);let z=e.update(C),W=C.material;if(Array.isArray(W)){let V=z.groups;for(let k=0,L=V.length;k<L;k++){let Q=V[k],J=W[Q.materialIndex];if(J&&J.visible){let ce=E(C,J,b,Y);C.onBeforeShadow(i,C,I,x,z,ce,Q),i.renderBufferDirect(x,null,z,ce,C,Q),C.onAfterShadow(i,C,I,x,z,ce,Q)}}}else if(W.visible){let V=E(C,W,b,Y);C.onBeforeShadow(i,C,I,x,z,V,null),i.renderBufferDirect(x,null,z,V,C,null),C.onAfterShadow(i,C,I,x,z,V,null)}}let B=C.children;for(let z=0,W=B.length;z<W;z++)A(B[z],I,x,b,Y)}function R(C){C.target.removeEventListener("dispose",R);for(let x in l){let b=l[x],Y=C.target.uuid;Y in b&&(b[Y].dispose(),delete b[Y])}}}function Dg(i,e){function t(){let P=!1,se=new rt,te=null,fe=new rt(0,0,0,0);return{setMask:function(j){te!==j&&!P&&(i.colorMask(j,j,j,j),te=j)},setLocked:function(j){P=j},setClear:function(j,H,_e,Pe,et){et===!0&&(j*=Pe,H*=Pe,_e*=Pe),se.set(j,H,_e,Pe),fe.equals(se)===!1&&(i.clearColor(j,H,_e,Pe),fe.copy(se))},reset:function(){P=!1,te=null,fe.set(-1,0,0,0)}}}function n(){let P=!1,se=!1,te=null,fe=null,j=null;return{setReversed:function(H){if(se!==H){let _e=e.get("EXT_clip_control");H?_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.ZERO_TO_ONE_EXT):_e.clipControlEXT(_e.LOWER_LEFT_EXT,_e.NEGATIVE_ONE_TO_ONE_EXT),se=H;let Pe=j;j=null,this.setClear(Pe)}},getReversed:function(){return se},setTest:function(H){H?ne(i.DEPTH_TEST):re(i.DEPTH_TEST)},setMask:function(H){te!==H&&!P&&(i.depthMask(H),te=H)},setFunc:function(H){if(se&&(H=hh[H]),fe!==H){switch(H){case gr:i.depthFunc(i.NEVER);break;case _r:i.depthFunc(i.ALWAYS);break;case xr:i.depthFunc(i.LESS);break;case ci:i.depthFunc(i.LEQUAL);break;case vr:i.depthFunc(i.EQUAL);break;case yr:i.depthFunc(i.GEQUAL);break;case Mr:i.depthFunc(i.GREATER);break;case Sr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}fe=H}},setLocked:function(H){P=H},setClear:function(H){j!==H&&(j=H,se&&(H=1-H),i.clearDepth(H))},reset:function(){P=!1,te=null,fe=null,j=null,se=!1}}}function s(){let P=!1,se=null,te=null,fe=null,j=null,H=null,_e=null,Pe=null,et=null;return{setTest:function(Ye){P||(Ye?ne(i.STENCIL_TEST):re(i.STENCIL_TEST))},setMask:function(Ye){se!==Ye&&!P&&(i.stencilMask(Ye),se=Ye)},setFunc:function(Ye,pn,mn){(te!==Ye||fe!==pn||j!==mn)&&(i.stencilFunc(Ye,pn,mn),te=Ye,fe=pn,j=mn)},setOp:function(Ye,pn,mn){(H!==Ye||_e!==pn||Pe!==mn)&&(i.stencilOp(Ye,pn,mn),H=Ye,_e=pn,Pe=mn)},setLocked:function(Ye){P=Ye},setClear:function(Ye){et!==Ye&&(i.clearStencil(Ye),et=Ye)},reset:function(){P=!1,se=null,te=null,fe=null,j=null,H=null,_e=null,Pe=null,et=null}}}let r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap,u={},p={},h=new WeakMap,g=[],_=null,y=!1,f=null,d=null,M=null,E=null,A=null,R=null,C=null,I=new Ee(0,0,0),x=0,b=!1,Y=null,w=null,B=null,z=null,W=null,V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),k=!1,L=0,Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(L=parseFloat(/^WebGL (\d)/.exec(Q)[1]),k=L>=1):Q.indexOf("OpenGL ES")!==-1&&(L=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),k=L>=2);let J=null,ce={},pe=i.getParameter(i.SCISSOR_BOX),ue=i.getParameter(i.VIEWPORT),Ne=new rt().fromArray(pe),nt=new rt().fromArray(ue);function tt(P,se,te,fe){let j=new Uint8Array(4),H=i.createTexture();i.bindTexture(P,H),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let _e=0;_e<te;_e++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,fe,0,i.RGBA,i.UNSIGNED_BYTE,j):i.texImage2D(se+_e,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,j);return H}let Z={};Z[i.TEXTURE_2D]=tt(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=tt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=tt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=tt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ne(i.DEPTH_TEST),a.setFunc(ci),Oe(!1),at(Bo),ne(i.CULL_FACE),qe(hn);function ne(P){u[P]!==!0&&(i.enable(P),u[P]=!0)}function re(P){u[P]!==!1&&(i.disable(P),u[P]=!1)}function Le(P,se){return p[P]!==se?(i.bindFramebuffer(P,se),p[P]=se,P===i.DRAW_FRAMEBUFFER&&(p[i.FRAMEBUFFER]=se),P===i.FRAMEBUFFER&&(p[i.DRAW_FRAMEBUFFER]=se),!0):!1}function we(P,se){let te=g,fe=!1;if(P){te=h.get(se),te===void 0&&(te=[],h.set(se,te));let j=P.textures;if(te.length!==j.length||te[0]!==i.COLOR_ATTACHMENT0){for(let H=0,_e=j.length;H<_e;H++)te[H]=i.COLOR_ATTACHMENT0+H;te.length=j.length,fe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,fe=!0);fe&&i.drawBuffers(te)}function Ie(P){return _!==P?(i.useProgram(P),_=P,!0):!1}let pt={[Bn]:i.FUNC_ADD,[Dc]:i.FUNC_SUBTRACT,[Fc]:i.FUNC_REVERSE_SUBTRACT};pt[Lc]=i.MIN,pt[Nc]=i.MAX;let Ge={[Uc]:i.ZERO,[Oc]:i.ONE,[Bc]:i.SRC_COLOR,[pr]:i.SRC_ALPHA,[Wc]:i.SRC_ALPHA_SATURATE,[Gc]:i.DST_COLOR,[zc]:i.DST_ALPHA,[Vc]:i.ONE_MINUS_SRC_COLOR,[mr]:i.ONE_MINUS_SRC_ALPHA,[Hc]:i.ONE_MINUS_DST_COLOR,[kc]:i.ONE_MINUS_DST_ALPHA,[Xc]:i.CONSTANT_COLOR,[qc]:i.ONE_MINUS_CONSTANT_COLOR,[Yc]:i.CONSTANT_ALPHA,[Zc]:i.ONE_MINUS_CONSTANT_ALPHA};function qe(P,se,te,fe,j,H,_e,Pe,et,Ye){if(P===hn){y===!0&&(re(i.BLEND),y=!1);return}if(y===!1&&(ne(i.BLEND),y=!0),P!==Pc){if(P!==f||Ye!==b){if((d!==Bn||A!==Bn)&&(i.blendEquation(i.FUNC_ADD),d=Bn,A=Bn),Ye)switch(P){case li:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Vo:i.blendFunc(i.ONE,i.ONE);break;case zo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ko:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ce("WebGLState: Invalid blending: ",P);break}else switch(P){case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Vo:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case zo:Ce("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ko:Ce("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ce("WebGLState: Invalid blending: ",P);break}M=null,E=null,R=null,C=null,I.set(0,0,0),x=0,f=P,b=Ye}return}j=j||se,H=H||te,_e=_e||fe,(se!==d||j!==A)&&(i.blendEquationSeparate(pt[se],pt[j]),d=se,A=j),(te!==M||fe!==E||H!==R||_e!==C)&&(i.blendFuncSeparate(Ge[te],Ge[fe],Ge[H],Ge[_e]),M=te,E=fe,R=H,C=_e),(Pe.equals(I)===!1||et!==x)&&(i.blendColor(Pe.r,Pe.g,Pe.b,et),I.copy(Pe),x=et),f=P,b=!1}function Ke(P,se){P.side===cn?re(i.CULL_FACE):ne(i.CULL_FACE);let te=P.side===Tt;se&&(te=!te),Oe(te),P.blending===li&&P.transparent===!1?qe(hn):qe(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),r.setMask(P.colorWrite);let fe=P.stencilWrite;o.setTest(fe),fe&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),ct(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?ne(i.SAMPLE_ALPHA_TO_COVERAGE):re(i.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(P){Y!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),Y=P)}function at(P){P!==Cc?(ne(i.CULL_FACE),P!==w&&(P===Bo?i.cullFace(i.BACK):P===Rc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):re(i.CULL_FACE),w=P}function T(P){P!==B&&(k&&i.lineWidth(P),B=P)}function ct(P,se,te){P?(ne(i.POLYGON_OFFSET_FILL),(z!==se||W!==te)&&(z=se,W=te,a.getReversed()&&(se=-se),i.polygonOffset(se,te))):re(i.POLYGON_OFFSET_FILL)}function We(P){P?ne(i.SCISSOR_TEST):re(i.SCISSOR_TEST)}function Qe(P){P===void 0&&(P=i.TEXTURE0+V-1),J!==P&&(i.activeTexture(P),J=P)}function ye(P,se,te){te===void 0&&(J===null?te=i.TEXTURE0+V-1:te=J);let fe=ce[te];fe===void 0&&(fe={type:void 0,texture:void 0},ce[te]=fe),(fe.type!==P||fe.texture!==se)&&(J!==te&&(i.activeTexture(te),J=te),i.bindTexture(P,se||Z[P]),fe.type=P,fe.texture=se)}function S(){let P=ce[J];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function m(){try{i.compressedTexImage2D(...arguments)}catch(P){Ce("WebGLState:",P)}}function D(){try{i.compressedTexImage3D(...arguments)}catch(P){Ce("WebGLState:",P)}}function q(){try{i.texSubImage2D(...arguments)}catch(P){Ce("WebGLState:",P)}}function $(){try{i.texSubImage3D(...arguments)}catch(P){Ce("WebGLState:",P)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(P){Ce("WebGLState:",P)}}function me(){try{i.compressedTexSubImage3D(...arguments)}catch(P){Ce("WebGLState:",P)}}function ie(){try{i.texStorage2D(...arguments)}catch(P){Ce("WebGLState:",P)}}function Ae(){try{i.texStorage3D(...arguments)}catch(P){Ce("WebGLState:",P)}}function Te(){try{i.texImage2D(...arguments)}catch(P){Ce("WebGLState:",P)}}function K(){try{i.texImage3D(...arguments)}catch(P){Ce("WebGLState:",P)}}function ee(P){Ne.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Ne.copy(P))}function ge(P){nt.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),nt.copy(P))}function xe(P,se){let te=l.get(se);te===void 0&&(te=new WeakMap,l.set(se,te));let fe=te.get(P);fe===void 0&&(fe=i.getUniformBlockIndex(se,P.name),te.set(P,fe))}function he(P,se){let fe=l.get(se).get(P);c.get(se)!==fe&&(i.uniformBlockBinding(se,fe,P.__bindingPointIndex),c.set(se,fe))}function Be(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},J=null,ce={},p={},h=new WeakMap,g=[],_=null,y=!1,f=null,d=null,M=null,E=null,A=null,R=null,C=null,I=new Ee(0,0,0),x=0,b=!1,Y=null,w=null,B=null,z=null,W=null,Ne.set(0,0,i.canvas.width,i.canvas.height),nt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ne,disable:re,bindFramebuffer:Le,drawBuffers:we,useProgram:Ie,setBlending:qe,setMaterial:Ke,setFlipSided:Oe,setCullFace:at,setLineWidth:T,setPolygonOffset:ct,setScissorTest:We,activeTexture:Qe,bindTexture:ye,unbindTexture:S,compressedTexImage2D:m,compressedTexImage3D:D,texImage2D:Te,texImage3D:K,updateUBOMapping:xe,uniformBlockBinding:he,texStorage2D:ie,texStorage3D:Ae,texSubImage2D:q,texSubImage3D:$,compressedTexSubImage2D:X,compressedTexSubImage3D:me,scissor:ee,viewport:ge,reset:Be}}function Fg(i,e,t,n,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ze,u=new WeakMap,p,h=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,m){return g?new OffscreenCanvas(S,m):ls("canvas")}function y(S,m,D){let q=1,$=ye(S);if(($.width>D||$.height>D)&&(q=D/Math.max($.width,$.height)),q<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){let X=Math.floor(q*$.width),me=Math.floor(q*$.height);p===void 0&&(p=_(X,me));let ie=m?_(X,me):p;return ie.width=X,ie.height=me,ie.getContext("2d").drawImage(S,0,0,X,me),Re("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+X+"x"+me+")."),ie}else return"data"in S&&Re("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),S;return S}function f(S){return S.generateMipmaps}function d(S){i.generateMipmap(S)}function M(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(S,m,D,q,$=!1){if(S!==null){if(i[S]!==void 0)return i[S];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let X=m;if(m===i.RED&&(D===i.FLOAT&&(X=i.R32F),D===i.HALF_FLOAT&&(X=i.R16F),D===i.UNSIGNED_BYTE&&(X=i.R8)),m===i.RED_INTEGER&&(D===i.UNSIGNED_BYTE&&(X=i.R8UI),D===i.UNSIGNED_SHORT&&(X=i.R16UI),D===i.UNSIGNED_INT&&(X=i.R32UI),D===i.BYTE&&(X=i.R8I),D===i.SHORT&&(X=i.R16I),D===i.INT&&(X=i.R32I)),m===i.RG&&(D===i.FLOAT&&(X=i.RG32F),D===i.HALF_FLOAT&&(X=i.RG16F),D===i.UNSIGNED_BYTE&&(X=i.RG8)),m===i.RG_INTEGER&&(D===i.UNSIGNED_BYTE&&(X=i.RG8UI),D===i.UNSIGNED_SHORT&&(X=i.RG16UI),D===i.UNSIGNED_INT&&(X=i.RG32UI),D===i.BYTE&&(X=i.RG8I),D===i.SHORT&&(X=i.RG16I),D===i.INT&&(X=i.RG32I)),m===i.RGB_INTEGER&&(D===i.UNSIGNED_BYTE&&(X=i.RGB8UI),D===i.UNSIGNED_SHORT&&(X=i.RGB16UI),D===i.UNSIGNED_INT&&(X=i.RGB32UI),D===i.BYTE&&(X=i.RGB8I),D===i.SHORT&&(X=i.RGB16I),D===i.INT&&(X=i.RGB32I)),m===i.RGBA_INTEGER&&(D===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),D===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),D===i.UNSIGNED_INT&&(X=i.RGBA32UI),D===i.BYTE&&(X=i.RGBA8I),D===i.SHORT&&(X=i.RGBA16I),D===i.INT&&(X=i.RGBA32I)),m===i.RGB&&(D===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),D===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),m===i.RGBA){let me=$?as:ke.getTransfer(q);D===i.FLOAT&&(X=i.RGBA32F),D===i.HALF_FLOAT&&(X=i.RGBA16F),D===i.UNSIGNED_BYTE&&(X=me===Xe?i.SRGB8_ALPHA8:i.RGBA8),D===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),D===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function A(S,m){let D;return S?m===null||m===Jt||m===Xi?D=i.DEPTH24_STENCIL8:m===Kt?D=i.DEPTH32F_STENCIL8:m===Wi&&(D=i.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Jt||m===Xi?D=i.DEPTH_COMPONENT24:m===Kt?D=i.DEPTH_COMPONENT32F:m===Wi&&(D=i.DEPTH_COMPONENT16),D}function R(S,m){return f(S)===!0||S.isFramebufferTexture&&S.minFilter!==xt&&S.minFilter!==yt?Math.log2(Math.max(m.width,m.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?m.mipmaps.length:1}function C(S){let m=S.target;m.removeEventListener("dispose",C),x(m),m.isVideoTexture&&u.delete(m)}function I(S){let m=S.target;m.removeEventListener("dispose",I),Y(m)}function x(S){let m=n.get(S);if(m.__webglInit===void 0)return;let D=S.source,q=h.get(D);if(q){let $=q[m.__cacheKey];$.usedTimes--,$.usedTimes===0&&b(S),Object.keys(q).length===0&&h.delete(D)}n.remove(S)}function b(S){let m=n.get(S);i.deleteTexture(m.__webglTexture);let D=S.source,q=h.get(D);delete q[m.__cacheKey],a.memory.textures--}function Y(S){let m=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(m.__webglFramebuffer[q]))for(let $=0;$<m.__webglFramebuffer[q].length;$++)i.deleteFramebuffer(m.__webglFramebuffer[q][$]);else i.deleteFramebuffer(m.__webglFramebuffer[q]);m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer[q])}else{if(Array.isArray(m.__webglFramebuffer))for(let q=0;q<m.__webglFramebuffer.length;q++)i.deleteFramebuffer(m.__webglFramebuffer[q]);else i.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&i.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let q=0;q<m.__webglColorRenderbuffer.length;q++)m.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(m.__webglColorRenderbuffer[q]);m.__webglDepthRenderbuffer&&i.deleteRenderbuffer(m.__webglDepthRenderbuffer)}let D=S.textures;for(let q=0,$=D.length;q<$;q++){let X=n.get(D[q]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(D[q])}n.remove(S)}let w=0;function B(){w=0}function z(){let S=w;return S>=s.maxTextures&&Re("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),w+=1,S}function W(S){let m=[];return m.push(S.wrapS),m.push(S.wrapT),m.push(S.wrapR||0),m.push(S.magFilter),m.push(S.minFilter),m.push(S.anisotropy),m.push(S.internalFormat),m.push(S.format),m.push(S.type),m.push(S.generateMipmaps),m.push(S.premultiplyAlpha),m.push(S.flipY),m.push(S.unpackAlignment),m.push(S.colorSpace),m.join()}function V(S,m){let D=n.get(S);if(S.isVideoTexture&&We(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&D.__version!==S.version){let q=S.image;if(q===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{Z(D,S,m);return}}else S.isExternalTexture&&(D.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,D.__webglTexture,i.TEXTURE0+m)}function k(S,m){let D=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&D.__version!==S.version){Z(D,S,m);return}else S.isExternalTexture&&(D.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,D.__webglTexture,i.TEXTURE0+m)}function L(S,m){let D=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&D.__version!==S.version){Z(D,S,m);return}t.bindTexture(i.TEXTURE_3D,D.__webglTexture,i.TEXTURE0+m)}function Q(S,m){let D=n.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&D.__version!==S.version){ne(D,S,m);return}t.bindTexture(i.TEXTURE_CUBE_MAP,D.__webglTexture,i.TEXTURE0+m)}let J={[br]:i.REPEAT,[an]:i.CLAMP_TO_EDGE,[Ar]:i.MIRRORED_REPEAT},ce={[xt]:i.NEAREST,[Kc]:i.NEAREST_MIPMAP_NEAREST,[ws]:i.NEAREST_MIPMAP_LINEAR,[yt]:i.LINEAR,[Yr]:i.LINEAR_MIPMAP_NEAREST,[qn]:i.LINEAR_MIPMAP_LINEAR},pe={[th]:i.NEVER,[ah]:i.ALWAYS,[nh]:i.LESS,[Da]:i.LEQUAL,[ih]:i.EQUAL,[Fa]:i.GEQUAL,[sh]:i.GREATER,[rh]:i.NOTEQUAL};function ue(S,m){if(m.type===Kt&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===yt||m.magFilter===Yr||m.magFilter===ws||m.magFilter===qn||m.minFilter===yt||m.minFilter===Yr||m.minFilter===ws||m.minFilter===qn)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,J[m.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,J[m.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,J[m.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,ce[m.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,ce[m.minFilter]),m.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,pe[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===xt||m.minFilter!==ws&&m.minFilter!==qn||m.type===Kt&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||n.get(m).__currentAnisotropy){let D=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,D.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,s.getMaxAnisotropy())),n.get(m).__currentAnisotropy=m.anisotropy}}}function Ne(S,m){let D=!1;S.__webglInit===void 0&&(S.__webglInit=!0,m.addEventListener("dispose",C));let q=m.source,$=h.get(q);$===void 0&&($={},h.set(q,$));let X=W(m);if(X!==S.__cacheKey){$[X]===void 0&&($[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,D=!0),$[X].usedTimes++;let me=$[S.__cacheKey];me!==void 0&&($[S.__cacheKey].usedTimes--,me.usedTimes===0&&b(m)),S.__cacheKey=X,S.__webglTexture=$[X].texture}return D}function nt(S,m,D){return Math.floor(Math.floor(S/D)/m)}function tt(S,m,D,q){let X=S.updateRanges;if(X.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,m.width,m.height,D,q,m.data);else{X.sort((K,ee)=>K.start-ee.start);let me=0;for(let K=1;K<X.length;K++){let ee=X[me],ge=X[K],xe=ee.start+ee.count,he=nt(ge.start,m.width,4),Be=nt(ee.start,m.width,4);ge.start<=xe+1&&he===Be&&nt(ge.start+ge.count-1,m.width,4)===he?ee.count=Math.max(ee.count,ge.start+ge.count-ee.start):(++me,X[me]=ge)}X.length=me+1;let ie=i.getParameter(i.UNPACK_ROW_LENGTH),Ae=i.getParameter(i.UNPACK_SKIP_PIXELS),Te=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,m.width);for(let K=0,ee=X.length;K<ee;K++){let ge=X[K],xe=Math.floor(ge.start/4),he=Math.ceil(ge.count/4),Be=xe%m.width,P=Math.floor(xe/m.width),se=he,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Be),i.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Be,P,se,te,D,q,m.data)}S.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ae),i.pixelStorei(i.UNPACK_SKIP_ROWS,Te)}}function Z(S,m,D){let q=i.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),m.isData3DTexture&&(q=i.TEXTURE_3D);let $=Ne(S,m),X=m.source;t.bindTexture(q,S.__webglTexture,i.TEXTURE0+D);let me=n.get(X);if(X.version!==me.__version||$===!0){t.activeTexture(i.TEXTURE0+D);let ie=ke.getPrimaries(ke.workingColorSpace),Ae=m.colorSpace===An?null:ke.getPrimaries(m.colorSpace),Te=m.colorSpace===An||ie===Ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);let K=y(m.image,!1,s.maxTextureSize);K=Qe(m,K);let ee=r.convert(m.format,m.colorSpace),ge=r.convert(m.type),xe=E(m.internalFormat,ee,ge,m.colorSpace,m.isVideoTexture);ue(q,m);let he,Be=m.mipmaps,P=m.isVideoTexture!==!0,se=me.__version===void 0||$===!0,te=X.dataReady,fe=R(m,K);if(m.isDepthTexture)xe=A(m.format===Yn,m.type),se&&(P?t.texStorage2D(i.TEXTURE_2D,1,xe,K.width,K.height):t.texImage2D(i.TEXTURE_2D,0,xe,K.width,K.height,0,ee,ge,null));else if(m.isDataTexture)if(Be.length>0){P&&se&&t.texStorage2D(i.TEXTURE_2D,fe,xe,Be[0].width,Be[0].height);for(let j=0,H=Be.length;j<H;j++)he=Be[j],P?te&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,he.width,he.height,ee,ge,he.data):t.texImage2D(i.TEXTURE_2D,j,xe,he.width,he.height,0,ee,ge,he.data);m.generateMipmaps=!1}else P?(se&&t.texStorage2D(i.TEXTURE_2D,fe,xe,K.width,K.height),te&&tt(m,K,ee,ge)):t.texImage2D(i.TEXTURE_2D,0,xe,K.width,K.height,0,ee,ge,K.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){P&&se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,xe,Be[0].width,Be[0].height,K.depth);for(let j=0,H=Be.length;j<H;j++)if(he=Be[j],m.format!==Ht)if(ee!==null)if(P){if(te)if(m.layerUpdates.size>0){let _e=ll(he.width,he.height,m.format,m.type);for(let Pe of m.layerUpdates){let et=he.data.subarray(Pe*_e/he.data.BYTES_PER_ELEMENT,(Pe+1)*_e/he.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,Pe,he.width,he.height,1,ee,et)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,K.depth,ee,he.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,xe,he.width,he.height,K.depth,0,he.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,K.depth,ee,ge,he.data):t.texImage3D(i.TEXTURE_2D_ARRAY,j,xe,he.width,he.height,K.depth,0,ee,ge,he.data)}else{P&&se&&t.texStorage2D(i.TEXTURE_2D,fe,xe,Be[0].width,Be[0].height);for(let j=0,H=Be.length;j<H;j++)he=Be[j],m.format!==Ht?ee!==null?P?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,he.width,he.height,ee,he.data):t.compressedTexImage2D(i.TEXTURE_2D,j,xe,he.width,he.height,0,he.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?te&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,he.width,he.height,ee,ge,he.data):t.texImage2D(i.TEXTURE_2D,j,xe,he.width,he.height,0,ee,ge,he.data)}else if(m.isDataArrayTexture)if(P){if(se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,xe,K.width,K.height,K.depth),te)if(m.layerUpdates.size>0){let j=ll(K.width,K.height,m.format,m.type);for(let H of m.layerUpdates){let _e=K.data.subarray(H*j/K.data.BYTES_PER_ELEMENT,(H+1)*j/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,H,K.width,K.height,1,ee,ge,_e)}m.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,ee,ge,K.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,K.width,K.height,K.depth,0,ee,ge,K.data);else if(m.isData3DTexture)P?(se&&t.texStorage3D(i.TEXTURE_3D,fe,xe,K.width,K.height,K.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,ee,ge,K.data)):t.texImage3D(i.TEXTURE_3D,0,xe,K.width,K.height,K.depth,0,ee,ge,K.data);else if(m.isFramebufferTexture){if(se)if(P)t.texStorage2D(i.TEXTURE_2D,fe,xe,K.width,K.height);else{let j=K.width,H=K.height;for(let _e=0;_e<fe;_e++)t.texImage2D(i.TEXTURE_2D,_e,xe,j,H,0,ee,ge,null),j>>=1,H>>=1}}else if(Be.length>0){if(P&&se){let j=ye(Be[0]);t.texStorage2D(i.TEXTURE_2D,fe,xe,j.width,j.height)}for(let j=0,H=Be.length;j<H;j++)he=Be[j],P?te&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,ee,ge,he):t.texImage2D(i.TEXTURE_2D,j,xe,ee,ge,he);m.generateMipmaps=!1}else if(P){if(se){let j=ye(K);t.texStorage2D(i.TEXTURE_2D,fe,xe,j.width,j.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ee,ge,K)}else t.texImage2D(i.TEXTURE_2D,0,xe,ee,ge,K);f(m)&&d(q),me.__version=X.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function ne(S,m,D){if(m.image.length!==6)return;let q=Ne(S,m),$=m.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+D);let X=n.get($);if($.version!==X.__version||q===!0){t.activeTexture(i.TEXTURE0+D);let me=ke.getPrimaries(ke.workingColorSpace),ie=m.colorSpace===An?null:ke.getPrimaries(m.colorSpace),Ae=m.colorSpace===An||me===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let Te=m.isCompressedTexture||m.image[0].isCompressedTexture,K=m.image[0]&&m.image[0].isDataTexture,ee=[];for(let H=0;H<6;H++)!Te&&!K?ee[H]=y(m.image[H],!0,s.maxCubemapSize):ee[H]=K?m.image[H].image:m.image[H],ee[H]=Qe(m,ee[H]);let ge=ee[0],xe=r.convert(m.format,m.colorSpace),he=r.convert(m.type),Be=E(m.internalFormat,xe,he,m.colorSpace),P=m.isVideoTexture!==!0,se=X.__version===void 0||q===!0,te=$.dataReady,fe=R(m,ge);ue(i.TEXTURE_CUBE_MAP,m);let j;if(Te){P&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Be,ge.width,ge.height);for(let H=0;H<6;H++){j=ee[H].mipmaps;for(let _e=0;_e<j.length;_e++){let Pe=j[_e];m.format!==Ht?xe!==null?P?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e,0,0,Pe.width,Pe.height,xe,Pe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e,Be,Pe.width,Pe.height,0,Pe.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e,0,0,Pe.width,Pe.height,xe,he,Pe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e,Be,Pe.width,Pe.height,0,xe,he,Pe.data)}}}else{if(j=m.mipmaps,P&&se){j.length>0&&fe++;let H=ye(ee[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,fe,Be,H.width,H.height)}for(let H=0;H<6;H++)if(K){P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,0,0,ee[H].width,ee[H].height,xe,he,ee[H].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,Be,ee[H].width,ee[H].height,0,xe,he,ee[H].data);for(let _e=0;_e<j.length;_e++){let et=j[_e].image[H].image;P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e+1,0,0,et.width,et.height,xe,he,et.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e+1,Be,et.width,et.height,0,xe,he,et.data)}}else{P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,0,0,xe,he,ee[H]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,Be,xe,he,ee[H]);for(let _e=0;_e<j.length;_e++){let Pe=j[_e];P?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e+1,0,0,xe,he,Pe.image[H]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,_e+1,Be,xe,he,Pe.image[H])}}}f(m)&&d(i.TEXTURE_CUBE_MAP),X.__version=$.version,m.onUpdate&&m.onUpdate(m)}S.__version=m.version}function re(S,m,D,q,$,X){let me=r.convert(D.format,D.colorSpace),ie=r.convert(D.type),Ae=E(D.internalFormat,me,ie,D.colorSpace),Te=n.get(m),K=n.get(D);if(K.__renderTarget=m,!Te.__hasExternalTextures){let ee=Math.max(1,m.width>>X),ge=Math.max(1,m.height>>X);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,X,Ae,ee,ge,m.depth,0,me,ie,null):t.texImage2D($,X,Ae,ee,ge,0,me,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),ct(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,$,K.__webglTexture,0,T(m)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,$,K.__webglTexture,X),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(S,m,D){if(i.bindRenderbuffer(i.RENDERBUFFER,S),m.depthBuffer){let q=m.depthTexture,$=q&&q.isDepthTexture?q.type:null,X=A(m.stencilBuffer,$),me=m.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ct(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,T(m),X,m.width,m.height):D?i.renderbufferStorageMultisample(i.RENDERBUFFER,T(m),X,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,X,m.width,m.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,me,i.RENDERBUFFER,S)}else{let q=m.textures;for(let $=0;$<q.length;$++){let X=q[$],me=r.convert(X.format,X.colorSpace),ie=r.convert(X.type),Ae=E(X.internalFormat,me,ie,X.colorSpace);ct(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,T(m),Ae,m.width,m.height):D?i.renderbufferStorageMultisample(i.RENDERBUFFER,T(m),Ae,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,Ae,m.width,m.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function we(S,m,D){let q=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let $=n.get(m.depthTexture);if($.__renderTarget=m,(!$.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),q){if($.__webglInit===void 0&&($.__webglInit=!0,m.depthTexture.addEventListener("dispose",C)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),ue(i.TEXTURE_CUBE_MAP,m.depthTexture);let Te=r.convert(m.depthTexture.format),K=r.convert(m.depthTexture.type),ee;m.depthTexture.format===on?ee=i.DEPTH_COMPONENT24:m.depthTexture.format===Yn&&(ee=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ee,m.width,m.height,0,Te,K,null)}}else V(m.depthTexture,0);let X=$.__webglTexture,me=T(m),ie=q?i.TEXTURE_CUBE_MAP_POSITIVE_X+D:i.TEXTURE_2D,Ae=m.depthTexture.format===Yn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(m.depthTexture.format===on)ct(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Ae,ie,X,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Ae,ie,X,0);else if(m.depthTexture.format===Yn)ct(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Ae,ie,X,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Ae,ie,X,0);else throw new Error("Unknown depthTexture format")}function Ie(S){let m=n.get(S),D=S.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==S.depthTexture){let q=S.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),q){let $=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,q.removeEventListener("dispose",$)};q.addEventListener("dispose",$),m.__depthDisposeCallback=$}m.__boundDepthTexture=q}if(S.depthTexture&&!m.__autoAllocateDepthBuffer)if(D)for(let q=0;q<6;q++)we(m.__webglFramebuffer[q],S,q);else{let q=S.texture.mipmaps;q&&q.length>0?we(m.__webglFramebuffer[0],S,0):we(m.__webglFramebuffer,S,0)}else if(D){m.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[q]),m.__webglDepthbuffer[q]===void 0)m.__webglDepthbuffer[q]=i.createRenderbuffer(),Le(m.__webglDepthbuffer[q],S,!1);else{let $=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=m.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,X)}}else{let q=S.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=i.createRenderbuffer(),Le(m.__webglDepthbuffer,S,!1);else{let $=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=m.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,X)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function pt(S,m,D){let q=n.get(S);m!==void 0&&re(q.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),D!==void 0&&Ie(S)}function Ge(S){let m=S.texture,D=n.get(S),q=n.get(m);S.addEventListener("dispose",I);let $=S.textures,X=S.isWebGLCubeRenderTarget===!0,me=$.length>1;if(me||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=m.version,a.memory.textures++),X){D.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(m.mipmaps&&m.mipmaps.length>0){D.__webglFramebuffer[ie]=[];for(let Ae=0;Ae<m.mipmaps.length;Ae++)D.__webglFramebuffer[ie][Ae]=i.createFramebuffer()}else D.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){D.__webglFramebuffer=[];for(let ie=0;ie<m.mipmaps.length;ie++)D.__webglFramebuffer[ie]=i.createFramebuffer()}else D.__webglFramebuffer=i.createFramebuffer();if(me)for(let ie=0,Ae=$.length;ie<Ae;ie++){let Te=n.get($[ie]);Te.__webglTexture===void 0&&(Te.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&ct(S)===!1){D.__webglMultisampledFramebuffer=i.createFramebuffer(),D.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let ie=0;ie<$.length;ie++){let Ae=$[ie];D.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,D.__webglColorRenderbuffer[ie]);let Te=r.convert(Ae.format,Ae.colorSpace),K=r.convert(Ae.type),ee=E(Ae.internalFormat,Te,K,Ae.colorSpace,S.isXRRenderTarget===!0),ge=T(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ee,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,D.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(D.__webglDepthRenderbuffer=i.createRenderbuffer(),Le(D.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),ue(i.TEXTURE_CUBE_MAP,m);for(let ie=0;ie<6;ie++)if(m.mipmaps&&m.mipmaps.length>0)for(let Ae=0;Ae<m.mipmaps.length;Ae++)re(D.__webglFramebuffer[ie][Ae],S,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae);else re(D.__webglFramebuffer[ie],S,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);f(m)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ie=0,Ae=$.length;ie<Ae;ie++){let Te=$[ie],K=n.get(Te),ee=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ee=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ee,K.__webglTexture),ue(ee,Te),re(D.__webglFramebuffer,S,Te,i.COLOR_ATTACHMENT0+ie,ee,0),f(Te)&&d(ee)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ie=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,q.__webglTexture),ue(ie,m),m.mipmaps&&m.mipmaps.length>0)for(let Ae=0;Ae<m.mipmaps.length;Ae++)re(D.__webglFramebuffer[Ae],S,m,i.COLOR_ATTACHMENT0,ie,Ae);else re(D.__webglFramebuffer,S,m,i.COLOR_ATTACHMENT0,ie,0);f(m)&&d(ie),t.unbindTexture()}S.depthBuffer&&Ie(S)}function qe(S){let m=S.textures;for(let D=0,q=m.length;D<q;D++){let $=m[D];if(f($)){let X=M(S),me=n.get($).__webglTexture;t.bindTexture(X,me),d(X),t.unbindTexture()}}}let Ke=[],Oe=[];function at(S){if(S.samples>0){if(ct(S)===!1){let m=S.textures,D=S.width,q=S.height,$=i.COLOR_BUFFER_BIT,X=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,me=n.get(S),ie=m.length>1;if(ie)for(let Te=0;Te<m.length;Te++)t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);let Ae=S.texture.mipmaps;Ae&&Ae.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let Te=0;Te<m.length;Te++){if(S.resolveDepthBuffer&&(S.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,me.__webglColorRenderbuffer[Te]);let K=n.get(m[Te]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,K,0)}i.blitFramebuffer(0,0,D,q,0,0,D,q,$,i.NEAREST),c===!0&&(Ke.length=0,Oe.length=0,Ke.push(i.COLOR_ATTACHMENT0+Te),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ke.push(X),Oe.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Oe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ke))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let Te=0;Te<m.length;Te++){t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.RENDERBUFFER,me.__webglColorRenderbuffer[Te]);let K=n.get(m[Te]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Te,i.TEXTURE_2D,K,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){let m=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[m])}}}function T(S){return Math.min(s.maxSamples,S.samples)}function ct(S){let m=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function We(S){let m=a.render.frame;u.get(S)!==m&&(u.set(S,m),S.update())}function Qe(S,m){let D=S.colorSpace,q=S.format,$=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||D!==hi&&D!==An&&(ke.getTransfer(D)===Xe?(q!==Ht||$!==Vt)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ce("WebGLTextures: Unsupported texture color space:",D)),m}function ye(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=z,this.resetTextureUnits=B,this.setTexture2D=V,this.setTexture2DArray=k,this.setTexture3D=L,this.setTextureCube=Q,this.rebindTextures=pt,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=qe,this.updateMultisampleRenderTarget=at,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=re,this.useMultisampledRTT=ct,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Lg(i,e){function t(n,s=An){let r,a=ke.getTransfer(s);if(n===Vt)return i.UNSIGNED_BYTE;if(n===$r)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Jr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===jo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Qo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Jo)return i.BYTE;if(n===Ko)return i.SHORT;if(n===Wi)return i.UNSIGNED_SHORT;if(n===Zr)return i.INT;if(n===Jt)return i.UNSIGNED_INT;if(n===Kt)return i.FLOAT;if(n===un)return i.HALF_FLOAT;if(n===el)return i.ALPHA;if(n===tl)return i.RGB;if(n===Ht)return i.RGBA;if(n===on)return i.DEPTH_COMPONENT;if(n===Yn)return i.DEPTH_STENCIL;if(n===nl)return i.RED;if(n===Kr)return i.RED_INTEGER;if(n===mi)return i.RG;if(n===jr)return i.RG_INTEGER;if(n===Qr)return i.RGBA_INTEGER;if(n===Ts||n===Cs||n===Rs||n===Is)if(a===Xe)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ts)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Rs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ts)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Cs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Rs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Is)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ea||n===ta||n===na||n===ia)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ea)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ta)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===na)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ia)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===sa||n===ra||n===aa||n===oa||n===la||n===ca||n===ha)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===sa||n===ra)return a===Xe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===aa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===oa)return r.COMPRESSED_R11_EAC;if(n===la)return r.COMPRESSED_SIGNED_R11_EAC;if(n===ca)return r.COMPRESSED_RG11_EAC;if(n===ha)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===ua||n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va||n===ya||n===Ma||n===Sa||n===ba||n===Aa)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ua)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===da)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===fa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===pa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ma)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ga)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===_a)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===xa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===va)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ya)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ma)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Sa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ba)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Aa)return a===Xe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ea||n===wa||n===Ta)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ea)return a===Xe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===wa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ta)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ca||n===Ra||n===Ia||n===Pa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Ca)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ra)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ia)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Pa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Xi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var Ng=`
void main() {
